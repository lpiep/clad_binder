...
raw_output <- list(
  postgis = readxl::read_excel('data/clad_omop_simulated_output_4.xlsx', sheet = 'postgis_responses', col_types = 'text'),
  degauss = readxl::read_excel('data/clad_omop_simulated_output_4.xlsx', sheet = 'degauss_responses', col_types = 'text'),
  nominatim = readxl::read_excel('data/clad_omop_simulated_output_4.xlsx', sheet = 'nominatim_responses', col_types = 'text')
...
ggplot(filter(compare, geocoder == 'postgis')) + 
  ...
  ylab('Log Distance from Gold Standard (m)') +   
  xlab('Geocode Rating') + 
