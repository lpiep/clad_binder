...
Here are the three worst cases of the Nominatim geocoder (as measured by the area of by the polygon they form). The "true" location is shown in blue, and the attempts at geocoding in red.
...
```{r}
mapview(baddies[[3]]$geometry, col.regions = 'red') + 
  mapview(baddies[[3]]$geometry_true)
```
